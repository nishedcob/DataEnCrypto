...
public class Llave_Invalido_Exception extends Exception{
     ...
     * @since 1.4
     */
    public Llave_Invalido_Exception(Throwable cause) {
        super("Error! Configuracion de Llave es Invalido!", cause);
    }
     ...
     * @since 1.4
     */
    public Llave_Invalido_Exception(String message, Throwable cause) {
        super(message, cause);
    }
}
